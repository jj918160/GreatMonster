...
bool Charecter1::init(){
    ...
    void Charecter1::mainLogic(){
        walk();
        schedule(schedule_selector(Charecter1::LogicStep),3.f);
    }
    void Charecter1::LogicStep(float dt){
         LStep++;
...
//void Charecter1::update(float dt){
//    CharecterBase::update();
//}
